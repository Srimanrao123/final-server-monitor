...
function Signup() {
    ...
    body: JSON.stringify({
      ...
      const res=await fetch("https://sriman.pythonanywhere.com",Options)
  ...
  return (
    <div className='h-screen bg-cover bg-[url(https://media.istockphoto.com/id/2163983591/vector/abstract-multicolored-gradient-vector-background-design-wallpaper-template-with-geometric.jpg?s=612x612&w=0&k=20&c=wb1CT6XfnlzyhA63kMaN6LW0EM-ltGJSPSPlSW9qHos=)]'>
        ...
        <h1 className='font-bold text-blue-500 text-[50px] text-center '>Signup Page</h1>
        <div className='flex flex-col  p-12 text-center'>
            ...
            <button onClick={userdetails} className='text-white bg-red-600 w-[100px] m-4'>Sign Up</button>
            <p className='border bg-blue-300 font-bold text-red-100'>already had an accout <button className="m-1 p-1 text-red-600 border border-red-700 border-[3px]" onClick={()=> navigate('/login')}>LOGIN</button></p>
